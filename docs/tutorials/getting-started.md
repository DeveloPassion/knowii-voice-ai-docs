...
This tutorial will walk you through using Knowii Voice AI for the first time.
...
- You can press **Ctrl+Shift+D** to show/hide the Debug tab (see [Debug Settings](../user-guide/debug-settings) for advanced troubleshooting options)
...
3. **Try** recording in that language
